...
- **Comprehensive Markdown Support**: Fully compatible with all Markdown syntax provided by the Hugo renderer.
- **Component Architecture**: Utilize reusable partials and shortcodes for effortless custom layouts.
- **Automatic Dark Mode**: Seamlessly adapts to user light or dark mode preferences.
- **Lightweight & Fast**: Optimized CSS and minimal JavaScript for superior performance.
- **Accessible HTML**: Semantic markup with ARIA labels for improved accessibility.
...
For detailed instructions and examples, visit the [Freedom Demo Site](https://freedom-demo.gauthamchettiar.com/).